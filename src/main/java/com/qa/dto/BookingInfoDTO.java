...
public class BookingInfoDTO {
    ...
    public BookingInfoDTO(Long standardScreeningId, Long deluxScreeningId, String firstName, String surname, String dateOfBirth, String email, String phoneNumber, String address, String postCode) {
        super();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getBookingInfoId(), getStandardScreeningId(), getDeluxScreeningId(), getFirstName(), getSurname(), getDateOfBirth(), getEmail(), getPhoneNumber(), getAddress(), getPostCode());
    }
}
